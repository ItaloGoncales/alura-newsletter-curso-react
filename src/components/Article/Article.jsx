...
const Article = ({ title, text, tags, image, alt }) => {
  return (
    <div className="p-5 bg-gray-200 dark:bg-dark-200 sm:rounded-xl sm:shadow-xl flex flex-col items-center gap-2 mx-5 sm:mx-0 sm:hover:shadow-gray-500 sm:hover:dark:shadow-black sm:hover:shadow-lg">
